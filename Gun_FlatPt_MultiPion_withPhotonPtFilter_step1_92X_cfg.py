...
# with command line options: step1 --filein file:Gun_FlatPt_MultiPion_withPhotonPtFilter_pythia8_92X.root --fileout file:step1.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-MCv1_92X_upgrade2017_realistic_v8-v1/GEN-SIM-DIGI-RAW --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 92X_upgrade2017_realistic_v10 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:2e34_v2 --datamix PreMix --era Run2_2017 --python_filename Gun_FlatPt_MultiPion_withPhotonPtFilter_step1_92X_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Gun_FlatPt_MultiPion_withPhotonPtFilter_pythia8_92X.root'),
