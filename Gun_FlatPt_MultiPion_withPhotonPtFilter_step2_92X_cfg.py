...
# with command line options: step2 --filein file:step1.root --fileout file:step2.root --mc --eventcontent RECOSIM --runUnscheduled --datatier GEN-SIM-RECO --conditions 92X_upgrade2017_realistic_v10 --step RAW2DIGI,L1Reco,RECO,EI --era Run2_2017 --python_filename Gun_FlatPt_MultiPion_withPhotonPtFilter_step2_92X_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
