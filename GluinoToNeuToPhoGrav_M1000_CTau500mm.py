...
# with command line options: Configuration/GenProduction/python/ThirteenTeV/GluinoToNeutralinoToGravitinoPhoton_M1000_CTau-500mm_13TeV_cff.py --fileout file:GluinoToNeuToPhoGrav_M1000_CTau500mm.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --python_filename GluinoToNeuToPhoGrav_M1000_CTau500mm.py --no_exec -n 33
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/ThirteenTeV/GluinoToNeutralinoToGravitinoPhoton_M1000_CTau-500mm_13TeV_cff.py nevts:33'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:GluinoToNeuToPhoGrav_M1000_CTau500mm.root'),
